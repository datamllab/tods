...
for cont_rate in [0.01, 0.05, 0.1, 0.15, 0.2, 0.25]:
    ...
    # Step 5: algorithm`
    step_5 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.tods.detection_algorithm.LSTMODetector'))
    step_5.add_argument(name='inputs', argument_type=ArgumentType.CONTAINER, data_reference='steps.4.produce')
    step_5.add_hyperparameter(name='feature_dim', argument_type=ArgumentType.VALUE, data=feature_dim)
