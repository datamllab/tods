...
step_5.add_hyperparameter(name='k', argument_type=ArgumentType.VALUE, data=5)
step_5.add_hyperparameter(name='stop_epochs', argument_type=ArgumentType.VALUE, data=20)
CONTAMINATION = 0.25
...
with open('mogaal_pipeline_k5_con' + str(CONTAMINATION) + '.json', 'w') as f:
    f.write(data)
    print(data)
