...
# Step 5: algorithm
step_5 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.tods.detection_algorithm.dagmm'))
...
with open('DAGMM_subseg_con' + str(CONTAMINATION) + '.json', 'w') as f:
    f.write(data)
    print(data)
