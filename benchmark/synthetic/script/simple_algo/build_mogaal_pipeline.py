...
# Step 4: algorithm
step_4 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.tods.detection_algorithm.pyod_mogaal'))
step_4.add_argument(name='inputs', argument_type=ArgumentType.CONTAINER, data_reference='steps.2.produce')
step_4.add_hyperparameter(name='k', argument_type=ArgumentType.VALUE, data=9)
step_4.add_hyperparameter(name='stop_epochs', argument_type=ArgumentType.VALUE, data=50)
...
with open('mogaal_pipeline_k9_con' + str(CONTAMINATION) + '.json', 'w') as f:
    f.write(data)
    print(data)
