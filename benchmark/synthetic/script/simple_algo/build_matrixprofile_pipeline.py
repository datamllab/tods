...
# Step 4: algorithm
step_4 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.tods.detection_algorithm.matrix_profile'))
...
with open('mp_pipeline_win10_con' + str(CONTAMINATION) + '.json', 'w') as f:
    f.write(data)
    print(data)
