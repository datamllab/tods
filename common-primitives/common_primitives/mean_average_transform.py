...
class MeanAverageTransform(UnsupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    """
    ...
    metadata = metadata_base.PrimitiveMetadata({ 
         ...
         "python_path": "d3m.primitives.anomaly_detection.MeanAverageTransform",
    ...
    def produce(self, *, inputs: Inputs, timeout: float = None, iterations: int = None) -> CallResult[Outputs]:
       ...
       output = inputs.rolling(3, on = 'timestamp').mean()
       print('output ---------------------------------------------')
       print(output)
       return(output)
...
MeanAverageTransform.__doc__ = Normalizer.__doc__
