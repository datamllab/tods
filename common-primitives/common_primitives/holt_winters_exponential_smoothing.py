...
class HoltWintersExponentialSmoothing(UnsupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    ...
    metadata = metadata_base.PrimitiveMetadata({ 
         ...
         "python_path": "d3m.primitives.anomaly_detection.HoltWintersExponentialSmoothing",
    ...
    def produce(self, *, inputs: Inputs, timeout: float = None, iterations: int = None) -> base.CallResult[Outputs]:
        ...
        try:
           ...
           for column in columns_to_calculate_simple_exponential_smoothing:
               outputs[column+"_holt_winters_smoothing"] = ExponentialSmoothing(inputs[column], seasonal_periods=4, trend = 'add', seasonal='mul').fit(use_boxcox=True).fittedvalues
