...
# # Step 3: statistical_mean_temporal_derivative
step_3 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.tods.feature_analysis.statistical_mean_temporal_derivative'))
