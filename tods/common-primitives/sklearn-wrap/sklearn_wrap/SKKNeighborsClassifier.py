...
class SKKNeighborsClassifier(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams],
                          ProbabilisticCompositionalityMixin[Inputs, Outputs, Params, Hyperparams]):
    """
    Primitive wrapping for sklearn KNeighborsClassifier
    ...
    metadata = metadata_base.PrimitiveMetadata({ 
         ...
         "python_path": "d3m.primitives.classification.k_neighbors.SKlearn",
         "source": {'name': 'JPL', 'contact': 'mailto:shah@jpl.nasa.gov', 'uris': ['https://gitlab.com/datadrivendiscovery/sklearn-wrap/issues', 'https://scikit-learn.org/stable/modules/generated/sklearn.neighbors.KNeighborsClassifier.html']},
         "version": "2019.11.13",
...
SKKNeighborsClassifier.__doc__ = KNeighborsClassifier.__doc__