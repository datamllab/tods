...
class HoltSmoothing(UnsupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    ...
    metadata = metadata_base.PrimitiveMetadata({ 
         ...
         "python_path": "d3m.primitives.anomaly_detection.HoltSmoothing",
    ...
    def produce(self, *, inputs: Inputs, timeout: float = None, iterations: int = None) -> base.CallResult[Outputs]:
        ...
        try:
           ...
           for column in columns_to_calculate_simple_exponential_smoothing:
               outputs[column+"_holt_smoothing"] = Holt(inputs[column]).fit(smoothing_level=0.2, smoothing_slope=0.2,optimized=False).fittedvalues
