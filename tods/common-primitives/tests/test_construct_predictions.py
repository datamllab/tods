...
from common_primitives import dataset_to_dataframe, construct_predictions, extract_columns_semantic_types
...
class ConstructPredictionsPrimitiveTestCase(unittest.TestCase):
    ...
    def test_correct_order(self):
        ...
        hyperparams_class = construct_predictions.ConstructPredictionsPrimitive.metadata.get_hyperparams()
    ...
    def test_float_vector(self):
        ...
        dataframe.metadata = dataframe.metadata.add_semantic_type((metadata_base.ALL_ELEMENTS, 1), 'https://metadata.datadrivendiscovery.org/types/PredictedTarget')
