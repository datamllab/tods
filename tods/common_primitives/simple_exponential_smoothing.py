...
class SimpleExponentialSmoothing(UnsupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    ...
    metadata = metadata_base.PrimitiveMetadata({ 
         ...
         "python_path": "d3m.primitives.anomaly_detection.SimpleExponentialSmoothing",
    ...
    def produce(self, *, inputs: Inputs, timeout: float = None, iterations: int = None) -> base.CallResult[Outputs]:
        ...
        try:
           ...
           if(self.hyperparams['use_columns']==()):
               columns_to_calculate_simple_exponential_smoothing = list(set(inputs.columns)-set(['d3mIndex','timestamp','ground_truth']))
           else:
               columns_to_calculate_simple_exponential_smoothing = self.hyperparams['use_columns']
           for column in columns_to_calculate_simple_exponential_smoothing:
               outputs[column+"_simple_exponential_smoothing"] = SimpleExpSmoothing(inputs[column]).fit(smoothing_level=0.2,optimized=False).fittedvalues
        except Exception as e:
               self.logger.error("Error in Calculating simple exponential smoothing",e)
