...
from .core.MultiGBRegOD import MultiGBRegOD
from .core.GBRegOD import GBRegOD
...
class GBRegODetectorPrimitive(UnsupervisedOutlierDetectorBase[Inputs, Outputs, Params, Hyperparams]):
    """
    Autoregressive models use gradient boosting regression to calculate a sample's
    ...
    approaches. See GBRegOD for univarite data.
    ...
    metadata = metadata_base.PrimitiveMetadata({
        ...
        "name": "GBRegODetector",
        "python_path": "d3m.primitives.tods.detection_algorithm.GBRegODetector",
        "source": {
        ...
        "id": str(uuid.uuid3(uuid.NAMESPACE_DNS, 'GBRegODetector'))
    })
    ...
    def __init__(self, *,
        ...
        self._clf = MultiGBRegOD(window_size=hyperparams['window_size'],
