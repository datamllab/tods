...
class AKRNNPrimitive(UnsupervisedOutlierDetectorBase[Inputs, Outputs, Params, Hyperparams]):
    """
    ...
    metadata = metadata_base.PrimitiveMetadata({
	    ...
	    'id': str(uuid.uuid3(uuid.NAMESPACE_DNS, 'AKRNNPrimitive')),
    })
    ...
    def __init__(self, *,
        ...
        self._clf = AKRNN(batch_size=hyperparams['batch_size'],
