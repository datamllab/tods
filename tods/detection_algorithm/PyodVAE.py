...
.. dropdown:: Attributes
    ...
    metadata = construct_primitive_metadata(module='detection_algorithm', name='pyod_vae', id='AutoEncoderPrimitive', primitive_family='anomaly_detect', hyperparams=['contamination'])
