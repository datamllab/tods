...
import pandas as pd
import os
from tods.sk_interface.detection_algorithm.XGBOD_skinterface import XGBODSKI
...
class XGBODSKI_TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.transformer = XGBODSKI(contamination=self.contamination)
