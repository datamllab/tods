...
output_dir = '../test/timeseries_processing'   #output directory

fit_available_primitives = ['SKPowerTransformerPrimitive', 'SKQuantileTransformerPrimitive', 'SKStandardScalerPrimitive']
...
import pandas as pd
import os
""" + 'from tods.sk_interface.timeseries_processing.' + primitve_api_name + ' import ' + class_name + '\n\n'
