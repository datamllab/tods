...
class SKTruncatedSVDTest(unittest.TestCase):
    def test_basic(self):
        ...
        hyperparams_class = SKTruncatedSVD.SKTruncatedSVD.metadata.get_hyperparams()
        primitive = SKTruncatedSVD.SKTruncatedSVD(hyperparams=hyperparams_class.defaults())
