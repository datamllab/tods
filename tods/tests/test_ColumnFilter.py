...
from data_processing import ColumnFilter
...
class ColumnFilterTest(unittest.TestCase):
    def test_basic(self):
        ...
        hyperparams_class = ColumnFilter.ColumnFilter.metadata.get_hyperparams()
        primitive = ColumnFilter.ColumnFilter(hyperparams=hyperparams_class.defaults())
