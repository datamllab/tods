...
from tods.feature_analysis import BKFilter


class BKFilterTest(unittest.TestCase):
    def test_basic(self):
        self.maxDiff = None
        ...
        hyperparams_class = BKFilter.BKFilter.metadata.get_hyperparams()
        primitive = BKFilter.BKFilter(hyperparams=hyperparams_class.defaults())
