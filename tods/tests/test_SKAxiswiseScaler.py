...
class SKStandardizationTestCase(unittest.TestCase):
    def test_basic(self):
        ...
        hyperparams_class = SKAxiswiseScaler.SKAxiswiseScaler.metadata.get_hyperparams()
        primitive = SKAxiswiseScaler.SKAxiswiseScaler(hyperparams=hyperparams_class.defaults())
