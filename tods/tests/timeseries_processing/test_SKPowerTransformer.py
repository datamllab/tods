...
class SKPowerTransformerTestCase(unittest.TestCase):
    def test_basic(self):
        self.maxDiff=None
        ...
        hyperparams_class = SKPowerTransformer.SKPowerTransformerPrimitive.metadata.get_hyperparams()
        primitive = SKPowerTransformer.SKPowerTransformerPrimitive(hyperparams=hyperparams_class.defaults())
