...
class PyodLODATestCase(unittest.TestCase):
    def setUp(self):
        ...
        hyperparams_default = LODAPrimitive.metadata.get_hyperparams().defaults()
        ...
        self.primitive = LODAPrimitive(hyperparams=hyperparams)
    ...
    def test_metadata(self):
        ...
        self.assertEqual(utils.to_json_structure(self.prediction_labels.metadata.to_internal_simple_structure()), [{
            ...
            'metadata': {
                'name': 'TODS.anomaly_detection_primitives.LODAPrimitive0_0',
            ...
            'metadata': {
                'name': 'TODS.anomaly_detection_primitives.LODAPrimitive0_1',
                'semantic_types': ['https://metadata.datadrivendiscovery.org/types/Attribute'],
                'structural_type': 'numpy.int64',
            },
        }, {
            ...
            'metadata': {
                'name': 'TODS.anomaly_detection_primitives.LODAPrimitive0_2',
                'semantic_types': ['https://metadata.datadrivendiscovery.org/types/Attribute'],
                'structural_type': 'numpy.int64',
            },
        }])
