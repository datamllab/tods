...
class LSTMODTestCase(unittest.TestCase):
    def setUp(self):
        ...
        hyperparams_default = LSTMODetectorPrimitive.metadata.get_hyperparams().defaults()
        hyperparams = hyperparams_default.replace({'contamination': self.contamination, })
        self.primitive = LSTMODetectorPrimitive(hyperparams=hyperparams)
