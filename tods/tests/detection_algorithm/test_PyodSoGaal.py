...
class PyodSoGaalTestCase(unittest.TestCase):
    def setUp(self):
        ...
        hyperparams_default = So_GaalPrimitive.metadata.get_hyperparams().defaults()
        ...
        self.primitive = So_GaalPrimitive(hyperparams=hyperparams)
    ...
    def test_metadata(self):
        ...
        self.assertEqual(utils.to_json_structure(self.prediction_labels.metadata.to_internal_simple_structure()), [{
            ...
            'metadata': {
                'name': 'So_Gaal Anomaly Detection0_0',
            ...
            'metadata': {
                'name': 'So_Gaal Anomaly Detection0_1',
                'semantic_types': ['https://metadata.datadrivendiscovery.org/types/Attribute'],
                'structural_type': 'numpy.int64',
            },
        }, {
            ...
            'metadata': {
                'name': 'So_Gaal Anomaly Detection0_2',
                'semantic_types': ['https://metadata.datadrivendiscovery.org/types/Attribute'],
                'structural_type': 'numpy.int64',
            },
        }])
