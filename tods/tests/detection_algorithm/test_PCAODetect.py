...
class KDiscordODetectTestCase(unittest.TestCase):
    def setUp(self):
        ...
        hyperparams_default = PCAODetectorPrimitive.metadata.get_hyperparams().defaults()
        ...
        self.primitive = PCAODetectorPrimitive(hyperparams=hyperparams)
