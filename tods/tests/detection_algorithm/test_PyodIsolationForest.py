...
class PyodIsolationForestTestCase(unittest.TestCase):
    def setUp(self):
        ...
        hyperparams_default = IsolationForestPrimitive.metadata.get_hyperparams().defaults()
        ...
        self.primitive = IsolationForestPrimitive(hyperparams=hyperparams)
    ...
    def test_metadata(self):
        ...
        self.assertEqual(utils.to_json_structure(self.prediction_labels.metadata.to_internal_simple_structure()), [{
            ...
            'metadata': {
                'name': 'TODS.anomaly_detection_primitives.IsolationForest0_0',
            ...
            'metadata': {
                'name': 'TODS.anomaly_detection_primitives.IsolationForest0_1',
                'semantic_types': ['https://metadata.datadrivendiscovery.org/types/Attribute'],
                'structural_type': 'numpy.int64',
            },
        }, {
