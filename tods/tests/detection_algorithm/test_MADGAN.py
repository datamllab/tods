...
#from tods.detection_algorithm.core.mad_gan.MADGANPrimitive import MADGANPrimitive
from tods.detection_algorithm.MADGAN import MADGANPrimitive

class MADGANTest(unittest.TestCase):
    def test_basic(self):
        self.maxDiff = None
