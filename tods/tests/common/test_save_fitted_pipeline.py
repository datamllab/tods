...
class testSaveFittedPipeline(unittest.TestCase):
  def test_save_fitted_happyCase(self):
    ...
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/fitted_pipeline.pkl'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/orders.pkl'))


    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/DeeplogLstm.pkl'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/Detector.pkl'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/LSTMOutlierDetector.pkl'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/VAE.pkl'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/MO_GAAL.pkl'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/SO_GAAL.pkl'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/AutoEncoder.pkl'))

    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/AutoEncoder'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/DeeplogLstm'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/Detector'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/LSTMOutlierDetector'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/MO_GAAL_discriminator'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/SO_GAAL_discriminator'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/SO_GAAL_generator'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/SO_GAAL_combine_model'))
    self.assertTrue(os.path.dirname(os.path.dirname(os.getcwd()) + ('/fitted_pipelines/') + str(fitted_pipeline_id) + '/model/VAE'))
