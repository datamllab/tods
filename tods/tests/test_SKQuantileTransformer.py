...
class SKQuantileTransformerTestCase(unittest.TestCase):
    def test_basic(self):
        ...
        hyperparams_class = SKQuantileTransformer.SKQuantileTransformer.metadata.get_hyperparams()
        primitive = SKQuantileTransformer.SKQuantileTransformer(hyperparams=hyperparams_class.defaults())
