...
from data_processing import DuplicationValidation
...
class DuplicationValidationTest(unittest.TestCase):
    def test_basic(self):
        ...
        hyperparams_class = DuplicationValidation.DuplicationValidation.metadata.get_hyperparams()
        primitive = DuplicationValidation.DuplicationValidation(hyperparams=hyperparams_class.defaults())
