...
class StatisticalMeanTestCase(unittest.TestCase):
    def test_basic(self):
        self.maxDiff=None
        ...
        hyperparams_class = StatisticalMean.StatisticalMeanPrimitive.metadata.get_hyperparams()
        ...
        expected_output = container.DataFrame(
            {'timestamp': [1, 3, 2, 5], 'values': [1.0, 2.0, 3.0, 4.0], 'b': [1.0, 4.0, 5.0, 6.0],
             'values_mean': [1.5, 1.5, 2.5, 3.5], 'b_mean': [2.5, 2.5, 4.5, 5.5]},
            columns=['timestamp', 'values', 'b', 'values_mean', 'b_mean'])

        self.assertEqual(output_main[['timestamp', 'values', 'b', 'values_mean',
                                      'b_mean']].values.tolist(), expected_output[
                             ['timestamp', 'values', 'b', 'values_mean', 'b_mean'
                              ]].values.tolist())
