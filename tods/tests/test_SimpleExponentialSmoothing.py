...
class SimpleExponentialSmoothingTestCase(unittest.TestCase):
    def test_basic(self):
        ...
        hyperparams_class = SimpleExponentialSmoothing.SimpleExponentialSmoothing.metadata.get_hyperparams()
        primitive = SimpleExponentialSmoothing.SimpleExponentialSmoothing(hyperparams=hyperparams_class.defaults())
