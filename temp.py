...
from tods import generate_dataset, load_pipeline, evaluate_pipeline, fit_pipeline
...
parser.add_argument('--pipeline_path', 
                    default=os.path.join(this_path, 'examples/axolotl_interface/example_pipelines/autoencoder_pipeline.json'),
...
# Run the pipeline
pipeline_result = fit_pipeline(dataset, pipeline, metric)
